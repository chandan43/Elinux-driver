...
u32 CM_PER=0x44E00000;           // Clock Module Peripheral Registers
...
static int onboardled_probe(struct platform_device *pdev)
{
	...
	pr_info("Clock module: clock_module_base address as seen by kernel: %p\n", clock_module_base);
